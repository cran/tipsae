...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 30, column 24 to column 28)",
                                                      " (in 'string', line 30, column 0 to column 30)",
                                                      " (in 'string', line 31, column 25 to column 30)",
                                                      " (in 'string', line 31, column 0 to column 32)",
                                                      " (in 'string', line 32, column 26 to column 27)",
                                                      " (in 'string', line 32, column 0 to column 29)",
                                                      " (in 'string', line 33, column 26 to column 36)",
                                                      " (in 'string', line 33, column 0 to column 40)",
                                                      " (in 'string', line 36, column 0 to column 21)",
                                                      " (in 'string', line 37, column 0 to column 20)",
                                                      " (in 'string', line 38, column 19 to column 25)",
                                                      " (in 'string', line 38, column 0 to column 27)",
                                                      " (in 'string', line 39, column 16 to column 17)",
                                                      " (in 'string', line 39, column 0 to column 31)",
                                                      " (in 'string', line 40, column 28 to column 35)",
                                                      " (in 'string', line 40, column 0 to column 37)",
                                                      " (in 'string', line 41, column 28 to column 35)",
                                                      " (in 'string', line 41, column 0 to column 37)",
                                                      " (in 'string', line 44, column 31 to column 35)",
                                                      " (in 'string', line 44, column 0 to column 37)",
                                                      " (in 'string', line 45, column 31 to column 35)",
                                                      " (in 'string', line 45, column 0 to column 37)",
                                                      " (in 'string', line 46, column 0 to column 31)",
                                                      " (in 'string', line 47, column 21 to column 26)",
                                                      " (in 'string', line 47, column 0 to column 28)",
...
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      theta_oos = Eigen::Matrix<double, -1, 1>(M_oos);
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"beta0\",\"type\":{\"name\":\"vector\",\"length\":" << beta0_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"z_beta\",\"type\":{\"name\":\"vector\",\"length\":" << P << "},\"block\":\"parameters\"},{\"name\":\"lambda_HS\",\"type\":{\"name\":\"vector\",\"length\":" << lambda_HS_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"z_c2\",\"type\":{\"name\":\"vector\",\"length\":" << z_c2_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"z_tau\",\"type\":{\"name\":\"vector\",\"length\":" << z_tau_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"v_raw\",\"type\":{\"name\":\"vector\",\"length\":" << length_v << "},\"block\":\"parameters\"},{\"name\":\"sigma_v\",\"type\":{\"name\":\"vector\",\"length\":" << sigma_v_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"nu\",\"type\":{\"name\":\"vector\",\"length\":" << nu_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"psi_d\",\"type\":{\"name\":\"vector\",\"length\":" << psi_d_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"lambda\",\"type\":{\"name\":\"vector\",\"length\":" << lambda_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"s_raw\",\"type\":{\"name\":\"vector\",\"length\":" << s_raw_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"sigma_s\",\"type\":{\"name\":\"vector\",\"length\":" << sigma_s_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"t_raw\",\"type\":{\"name\":\"matrix\",\"rows\":" << t_raw_1dim__ << ",\"cols\":" << t_raw_2dim__ << "},\"block\":\"parameters\"},{\"name\":\"sigma_t\",\"type\":{\"name\":\"vector\",\"length\":" << sigma_t_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"w\",\"type\":{\"name\":\"vector\",\"length\":" << w_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"p\",\"type\":{\"name\":\"vector\",\"length\":" << p_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"gamma_p0\",\"type\":{\"name\":\"vector\",\"length\":" << gamma_p0_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"gamma_p1\",\"type\":{\"name\":\"vector\",\"length\":" << gamma_p1_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"gamma0_p0\",\"type\":{\"name\":\"vector\",\"length\":" << gamma0_p0_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"gamma0_p1\",\"type\":{\"name\":\"vector\",\"length\":" << gamma0_p1_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" << P << "},\"block\":\"transformed_parameters\"},{\"name\":\"tau\",\"type\":{\"name\":\"vector\",\"length\":" << tau_1dim__ << "},\"block\":\"transformed_parameters\"},{\"name\":\"c2\",\"type\":{\"name\":\"vector\",\"length\":" << c2_1dim__ << "},\"block\":\"transformed_parameters\"},{\"name\":\"lambda_tilde\",\"type\":{\"name\":\"vector\",\"length\":" << lambda_tilde_1dim__ << "},\"block\":\"transformed_parameters\"},{\"name\":\"theta\",\"type\":{\"name\":\"vector\",\"length\":" << M_is << "},\"block\":\"transformed_parameters\"},{\"name\":\"b1\",\"type\":{\"name\":\"vector\",\"length\":" << M_is << "},\"block\":\"transformed_parameters\"},{\"name\":\"a1\",\"type\":{\"name\":\"vector\",\"length\":" << M_is << "},\"block\":\"transformed_parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" << M_is << "},\"block\":\"transformed_parameters\"},{\"name\":\"phi\",\"type\":{\"name\":\"vector\",\"length\":" << phi_1dim__ << "},\"block\":\"transformed_parameters\"},{\"name\":\"lambda1\",\"type\":{\"name\":\"vector\",\"length\":" << lambda1_1dim__ << "},\"block\":\"transformed_parameters\"},{\"name\":\"lambda2\",\"type\":{\"name\":\"vector\",\"length\":" << lambda2_1dim__ << "},\"block\":\"transformed_parameters\"},{\"name\":\"b2\",\"type\":{\"name\":\"vector\",\"length\":" << b2_1dim__ << "},\"block\":\"transformed_parameters\"},{\"name\":\"a2\",\"type\":{\"name\":\"vector\",\"length\":" << a2_1dim__ << "},\"block\":\"transformed_parameters\"},{\"name\":\"p0\",\"type\":{\"name\":\"vector\",\"length\":" << p0_1dim__ << "},\"block\":\"transformed_parameters\"},{\"name\":\"p1\",\"type\":{\"name\":\"vector\",\"length\":" << p1_1dim__ << "},\"block\":\"transformed_parameters\"},{\"name\":\"v\",\"type\":{\"name\":\"vector\",\"length\":" << length_v << "},\"block\":\"transformed_parameters\"},{\"name\":\"s\",\"type\":{\"name\":\"vector\",\"length\":" << s_1dim__ << "},\"block\":\"transformed_parameters\"},{\"name\":\"t\",\"type\":{\"name\":\"matrix\",\"rows\":" << t_1dim__ << ",\"cols\":" << t_2dim__ << "},\"block\":\"transformed_parameters\"},{\"name\":\"reffs\",\"type\":{\"name\":\"vector\",\"length\":" << M_is << "},\"block\":\"transformed_parameters\"},{\"name\":\"reffs_oos\",\"type\":{\"name\":\"vector\",\"length\":" << M_oos << "},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" << M_is << "},\"block\":\"generated_quantities\"},{\"name\":\"y_rep\",\"type\":{\"name\":\"vector\",\"length\":" << M_is << "},\"block\":\"generated_quantities\"},{\"name\":\"psi_OOS\",\"type\":{\"name\":\"array\",\"length\":" << 1 << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"generated_quantities\"},{\"name\":\"v_oos\",\"type\":{\"name\":\"array\",\"length\":" << 1 << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"generated_quantities\"},{\"name\":\"label_mixt\",\"type\":{\"name\":\"int\"},\"block\":\"generated_quantities\"},{\"name\":\"probs\",\"type\":{\"name\":\"vector\",\"length\":" << probs_1dim__ << "},\"block\":\"generated_quantities\"},{\"name\":\"theta_oos\",\"type\":{\"name\":\"vector\",\"length\":" << M_oos << "},\"block\":\"generated_quantities\"}]";
    return s__.str();
